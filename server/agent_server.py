...
class AgentServer:
    ...
    @staticmethod
    def start_agent(agent_class, name: str, port: Optional[int] = None, **kwargs) -> Tuple[Any, int]:
        """
    ...
    @staticmethod
    async def start_mcp_agent(agent_class, name: str, mcp_servers: Optional[Dict[str, str]] = None, 
                      port: Optional[int] = None, **kwargs) -> Tuple[Any, int]:
        """
    ...
    async def start_mcp_servers(server_configs: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for config in server_configs:
            ...
            try:
                ...
                logger.error(f"Failed to import MCP server {server_var} from {module_name}: {e}")
                continue
