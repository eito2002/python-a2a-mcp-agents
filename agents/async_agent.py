            ...
            try:
                ...
                if "messages" in data:
                    ...
                    if data["messages"] and "parts" in data["messages"][0] and "role" in data["messages"][0]:
                        is_google_format = True
                    return await self._handle_conversation_request(data, is_google_format)
        ...
        async def a2a_tasks_send(request: Request):
            ...
            try:
                ...
                if "jsonrpc" in request_data:
                    ...
                    return await self._handle_task_request(request_data, is_google_format)
...
# Example usage
class MyAsyncAgent(FastAPIAgent):
    """Example custom async agent implementation"""
    ...
    async def handle_message_async(self, message: Message) -> Message:
        ...
        if message.content.type == "text":
            ...
            # Basic handling for non-text messages
            return Message(
                content=TextContent(text="Received non-text message"),
                role=MessageRole.AGENT,
                parent_message_id=message.message_id,
