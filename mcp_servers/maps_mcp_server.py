...
from python_a2a.mcp import FastMCP, text_response, image_response, error_response
...
def generate_ascii_map(location: str, map_type: str = "weather") -> str:
    ...
    if map_type == "weather":
        ...
        symbols = ["☁", "☀", "☂", "☔"] if map_type == "weather" else ["⛰", "🌊", "🌲", "🏙"]
        for _ in range(10):
...
@maps_mcp.tool(
    name="generate_terrain_map",
    description="Generate a terrain map for a location"
)
